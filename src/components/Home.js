...
import candy from '../assets/images/Cynthia-Inga.jpg';
import resume from '../assets/My resume.pdf';

export default class Home extends Component {
  render() {
    return (
      <div className="home-page-container" name="home">
        ...
        <div className="home-content">
          <div className="text-content">
            ...
            <div className="profession-area">
              <h3 className="profession" data-aos="fade-up-right">
          ...
          <div className="image-container" data-aos="zoom-in">
            <div className="image">
              <img src={candy} alt="homeImage" className="home-image" />
              <svg
                version="1.0"
                className="dots-svg"
